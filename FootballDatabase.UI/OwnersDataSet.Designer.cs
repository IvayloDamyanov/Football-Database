...
namespace FootballDatabase.UI {
    ...
    public partial class OwnersDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/OwnersDataSet.xsd";
        ...
        public partial class OwnersDataTable : global::System.Data.TypedTableBase<OwnersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OwnersRow AddOwnersRow(int TeamId, string Name, string Nationality, int Age, decimal Incomes, bool IsDeleted) {
...
namespace FootballDatabase.UI.OwnersDataSetTableAdapters {
    ...
    public partial class OwnersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Owners] WHERE (([Id] = @Original_Id) AND ([TeamId] = @Original_TeamId) AND ([Name] = @Original_Name) AND ((@IsNull_Nationality = 1 AND [Nationality] IS NULL) OR ([Nationality] = @Original_Nationality)) AND ([Age] = @Original_Age) AND ([Incomes] = @Original_Incomes) AND ([IsDeleted] = @Original_IsDeleted))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Owners] ([TeamId], [Name], [Nationality], [Age], [Incomes], [IsDeleted]) VALUES (@TeamId, @Name, @Nationality, @Age, @Incomes, @IsDeleted);
SELECT Id, TeamId, Name, Nationality, Age, Incomes, IsDeleted FROM Owners WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Owners] SET [TeamId] = @TeamId, [Name] = @Name, [Nationality] = @Nationality, [Age] = @Age, [Incomes] = @Incomes, [IsDeleted] = @IsDeleted WHERE (([Id] = @Original_Id) AND ([TeamId] = @Original_TeamId) AND ([Name] = @Original_Name) AND ((@IsNull_Nationality = 1 AND [Nationality] IS NULL) OR ([Nationality] = @Original_Nationality)) AND ([Age] = @Original_Age) AND ([Incomes] = @Original_Incomes) AND ([IsDeleted] = @Original_IsDeleted));
SELECT Id, TeamId, Name, Nationality, Age, Incomes, IsDeleted FROM Owners WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, TeamId, Name, Nationality, Age, Incomes, IsDeleted FROM dbo.Owners";
        ...
        public virtual int Delete(int Original_Id, int Original_TeamId, string Original_Name, string Original_Nationality, int Original_Age, decimal Original_Incomes, bool Original_IsDeleted) {
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((decimal)(Original_Incomes));
        ...
        public virtual int Insert(int TeamId, string Name, string Nationality, int Age, decimal Incomes, bool IsDeleted) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((decimal)(Incomes));
        ...
        public virtual int Update(int TeamId, string Name, string Nationality, int Age, decimal Incomes, bool IsDeleted, int Original_Id, int Original_TeamId, string Original_Name, string Original_Nationality, int Original_Age, decimal Original_Incomes, bool Original_IsDeleted, int Id) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(Incomes));
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((decimal)(Original_Incomes));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int TeamId, string Name, string Nationality, int Age, decimal Incomes, bool IsDeleted, int Original_Id, int Original_TeamId, string Original_Name, string Original_Nationality, int Original_Age, decimal Original_Incomes, bool Original_IsDeleted) {
            return this.Update(TeamId, Name, Nationality, Age, Incomes, IsDeleted, Original_Id, Original_TeamId, Original_Name, Original_Nationality, Original_Age, Original_Incomes, Original_IsDeleted, Original_Id);
        }
    }
